...
static const char *colors[][3]      = {
	...
	[SchemeSel]  =      { focused_foreground,    focused_background,  focused_background },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", background, "-nf", foreground, "-sb", focused_background, "-sf", focused_foreground, NULL };
